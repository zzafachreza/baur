...
export default function DokterDetail({ navigation, route }) {
    ...
    return (
        <SafeAreaView style={{
            ...
            <MyButton onPress={() => {
                let urlWA = 'https://wa.me/' + item.telepon + `?text=Hallo *${item.nama_dokter}*, saya ingin konsultasi..`;

                Linking.openURL(urlWA)

            }} radius={0} Icons="logo-whatsapp" title="Konsultasi Via Whatsapp" />
        </SafeAreaView>
    )
}
